...
Much of the HPC software on the clusters
...
Qsub/Bsub/Sbatch can allocate multiple cores and nodes, but the script runs on one core on one node sequentially.  Simply allocating more cores DOES NOT make jobs faster.
...
\item Use job arrays, or SimpleQueue (better)
...
\item Typically specify option (-p, -n) and count
...
\item Come to office hours: \url{http://research.computing.yale.edu/hpc-support/office-hours-support}
\end{itemize}
\end{frame}

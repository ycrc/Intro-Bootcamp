...
Torque: qsub -I -q fas_devel
LSF:    bsub -Is -q interactive bash
Slurm:  srun -p general --pty bash
...
LSF: bsub -n 16 -R 20000 -M 20000 t.sh
...
\hline
\textbf{Queue} & \textbf{Walltime def/max}& \textbf{MAX jobs/cpus} & \textbf{Notes} \\
\hline
...
\textbf{Queue} & \textbf{Walltime def/max}& \textbf{MAX jobs/cpus} & \textbf{Notes} \\
\hline
\textbf{general} & 7/30 &  10/100 & default \\
\hline
\textbf{interactive} & 1/1 &  4/4 &  \\
\hline
\textbf{bigmem} & 7/30 & ?/? & 1.5TB RAM \\
\hline
\textbf{gpu} & ?/? & ?/? & 2 GPUS/node \\
\hline
\end{tabular}
...
\textbf{Queue} & \textbf{Walltime def/max}& \textbf{MAX jobs/cpus} & \textbf{Notes} \\
\hline
\textbf{default} & 7/30 &  10/100 & default \\
\hline
\textbf{interactive} & 1/1 &  10/64 &  \\
\hline
\textbf{bigmem} & 7/30 & ?/? & 1.5TB RAM \\
\hline
\end{tabular}

...
%----------- slide --------------------------------------------------%
\begin{frame}[fragile]
\frametitle{Summary of Yale Clusters (Aug 2017)}
...
Omega-next.hpc.yale.edu can be used for slurm testing.
...
\item -N \textit{N} forces job to be scheduled onto N nodes.  Rarely useful.
\end{itemize}
